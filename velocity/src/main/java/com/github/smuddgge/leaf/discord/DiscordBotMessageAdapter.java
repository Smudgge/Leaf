...
public class DiscordBotMessageAdapter {
    ...
    public DiscordBotMessageAdapter(@NotNull ConfigurationSection section, @NotNull String path, @NotNull String alternative) {
        ...
        this.parser = string -> Leaf.get().getPlaceholderManager().parseLeafPlaceholders(string, null);
    }
     ...
     * @return This instance.
     */
    public @NotNull DiscordBotMessageAdapter setParser(@NotNull PlayerUser user) {
        this.parser = string -> Leaf.get().getPlaceholderManager().parseLeafPlaceholders(string, user);
        return this;
    }
